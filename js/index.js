(function(){
  ...
  document.getElementById('inquiry_form').addEventListener('submit', function(e) {
    try {
      ...
      this.innerHTML = '<div class="inquiry-submitted">Thank you for your interest! Look out for membership@identity.foundation;<br> also in your spam filter. <br> You also subscribed for the DIF Monthly newsletter.<div>';
