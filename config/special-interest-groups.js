module.exports = {
  activeSIGs: {
    "hospitality-travel": {
      ...
      charters: {
        "H&T SIG documentation": {
          links: [
            {
              text: "Mailing List",
              href: "https://lists.identity.foundation/g/hospitalityandtravel/"
            },
            {
      ...
      projects: {
        "Current work items": {
          ...
          links: [
            {
              text: "Decentralised Travel Profile",
              href: "https://identity.foundation/Hospitality-and-Travel-SIG/spec/",
              note: "(Published June 2023)"
            }
          ]
        }
      },
      chairs: {
        "Nick Price": {
          title: "CEO @ NetSys Technology",
          photo: "/images/photos/nick-price.jpg",
          linkedin: "nickprice1",
          twitter: "NetSysNick"
        },
        "Gene Quinn": {
      ...
      charters: {
        "China SIG documentation": {
          links: [
            {
              text: "SIG Charter",
              href: "https://hackmd.io/@kztxsZRVTY6JnzXKkhQG-w/rJvNR32RT"
            },
            {
              text: "SIG GitHub Repos",
    ...
    "japan": {
      ...
      chairs: {
        "Shigeya Suzuki": {
          title: "Professor, Keio University",
          photo: "/images/photos/shigeya-suzuki.jpg",
          linkedin: "shigeya"
        }
      }
    },
    ...
    "iot": {
      ...
      charters: {
        "IoT SIG documentation": {
          links: [
            {
              text: "SIG Charter",
              href: "https://github.com/decentralized-identity/SIG-IoT/blob/main/charter.md"
            },
            {
              text: "Mailing List",
              href: "https://lists.identity.foundation/g/iot-sig"
            },
            {
              text: "GitHub Repository",
      ...
      projects: {
        "Current work items": {
          links: [
            {
              text: "IoT Identity Management Specifications",
              href: "https://github.com/decentralized-identity/SIG-IoT/specs/"
            },
            {
              text: "Device Authentication Protocols",
              href: "https://github.com/decentralized-identity/SIG-IoT/protocols/"
            }
          ]
        }
      },
      ...
      charters: {
        "Glossary SIG documentation": {
          links: [
            {
              text: "SIG Charter",
              href: "https://github.com/decentralized-identity/SIG-Glossary/blob/main/charter.md"
            },
            {
              text: "Mailing List",
              href: "https://lists.identity.foundation/g/glossary-sig"
            },
            {
              text: "GitHub Repository",
      ...
      projects: {
        "Current work items": {
          links: [
            {
              text: "DIF Glossary",
              href: "https://github.com/decentralized-identity/SIG-Glossary/blob/main/glossary.md"
            },
            {
              text: "Term Mapping",
